...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cyclesRef = FirebaseDatabase.getInstance().getReference().child("Requested Cycles");

        FirebaseRecyclerOptions<History> options =
                new FirebaseRecyclerOptions.Builder<History>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Requested Cycles"), History.class)
                        .build();

        mainAdapter = new HomeAdapter(options);
